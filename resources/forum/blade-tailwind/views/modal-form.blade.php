<div tabindex="-1" role="dialog" data-modal="{{ $key }}" class="fixed top-0 left-0 w-full h-full hidden z-10 items-center justify-center">
    ...
    <div class="relative bg-white dark:bg-slate-900 text-gray-900 dark:text-gray-100 rounded-md max-w-screen-sm w-full m-2" role="document">
        <div class="">
            <div class="border-b border-gray-200 dark:border-gray-600 px-6 py-4 flex justify-between">
            ...
            <form action="{{ $route }}" method="POST">
                ...
                <div class="border-t border-gray-200 dark:border-gray-600 px-6 py-4 flex justify-end gap-4">
